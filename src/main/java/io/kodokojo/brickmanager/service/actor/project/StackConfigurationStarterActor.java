...
public class StackConfigurationStarterActor extends AbstractActor {
    ...
    public StackConfigurationStarterActor(DnsManager dnsManager, BrickUrlFactory brickUrlFactory, ApplicationConfig applicationConfig) {
        ...
        receive(ReceiveBuilder.match(StackConfigurationStartMsg.class, this::onStackConfigurationStartRequest)
                .match(BrickStateEvent.class, this::onBrickStateChanged)
                .matchAny(this::unhandled).build());
    }

    private void onStackConfigurationStartRequest(StackConfigurationStartMsg msg) {
        intialMsg = msg;
